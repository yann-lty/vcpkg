...
function(vcpkg_build_cmake)
    ...
    foreach(BUILDTYPE "rel" "dbg")
        message(STATUS "Build ${TARGET_TRIPLET}-${BUILDTYPE}")
        set(LOGPREFIX "${CURRENT_BUILDTREES_DIR}/${_bc_LOGFILE_ROOT}-${TARGET_TRIPLET}-${BUILDTYPE}")
        set(LOGS)

        if(BUILDTYPE STREQUAL "rel")
            set(CONFIG "Release")
        else()
            set(CONFIG "Debug")
        endif()
        ...
        execute_process(
            ...
            WORKING_DIRECTORY ${CURRENT_BUILDTREES_DIR}/${TARGET_TRIPLET}-${BUILDTYPE})
        if(error_code)
            ...
            if(out_contents MATCHES "LINK : fatal error LNK1102:" OR err_contents MATCHES "LINK : fatal error LNK1102:")
        ...
        message(STATUS "Build ${TARGET_TRIPLET}-${BUILDTYPE} done")
    endforeach()
endfunction()
